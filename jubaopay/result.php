...
<head>
	...
	<link href="http://mapi.jubaopay.com/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="header-container">
  <div class="header-content">
	  <div class="logo-new fll"><a href="http://mapi.jubaopay.comjavascript:void(0);" title="聚宝支付-让支付更简单" target="_blank"><h1>聚宝支付-让支付更简单</h1></a></div>
    </div>
