        ...
        bootstro.next = function()
        {
            ...
            else 
            {
                ...
                if (typeof settings.onStep == 'function')
                    settings.onStep.call(this, {idx : activeIndex, direction : 'proceed'});//
            }
        };
