...
<section>
	<div class="container-fluid">
		...
		<h3 class="sub-title">Panel Card</h3>
...
&lt;/div&gt;
		...
		<!--===================================== Tabs ===================================================-->
		<a name="tab-line" id="tab-line">&nbsp;</a>
		<h3 class="sub-title">Panel Tab</h3>
...
&lt;/div&gt;</div></pre>
				...
				<h5><code>nav-line</code> Add a bottom border to the tab content.</5>
				<pre class="well prettyprint">
					<input class="btn btn-info btnCopy" type="button" value="Copy" data-trigger="hover" data-toggle="tooltip" data-original-title="Copy to clipboard" data-placement="top"/><div class="code_content">
&lt;div class=&quot;collapse not-sm not-md not-lg&quot; id=&quot;collapseSearch&quot;&gt;
  &lt;div class=&quot;panel-tabs&quot;&gt;
...
&lt;/div&gt;</div></pre>
				<blockquote class="alert-success" role="alert">
					<h4 class="text-success">Source Code</h4>
					<p>Source code for panel tab can be download here.</p>
					<p><a href="myjs/source-code/panel-tab.html" class="btn btn-success" download>Download</a></p>
				</blockquote>	
			</div>
		</div>
...
&lt;/div&gt;</div></pre>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title"><strong>Job Card (standout)</strong></div>
			</div>
			<div class="panel-body">
				<blockquote class="alert-default">
...
&lt;/div&gt;</div></pre>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title"><strong>Job Card (My Saved Jobs)</strong></div>
			</div>
			<div class="panel-body">
				<blockquote class="alert-default">
					Job Card (My Saved Jobs) use grid system to seperate into 4 different columns.
				</blockquote>	
				<div class="well clearfix">
					<div class="row">
						<div class="col-xs-12">
...
&lt;/div&gt;</div></pre>
		...
		<div class="panel">
			<div class="panel-body">
				<blockquote class="alert-default">
					<h5>Side footer also use <code>panel-group</code> to group multiple <code>panel-basic</code> together. <code>side-footer</code> is use to disable the background color. </h5>
