...
define('select2/defaults',[
  ...
  Defaults.prototype.reset = function () {
    ...
    this.defaults = {
      ...
      theme: 'default',
      width: 'resolve',
      responsive: true // 2015-03-10 JOBSTREET Customization: Set variable responsive to true
    };
  };
...
define('select2/core',[
  ...
  Select2.prototype._resolveWidth = function ($element, method) {
    ...
    if (method == 'resolve') {
      ...
      if (styleWidth != null) {
        return styleWidth;
      }else if ( this.options.get('responsive') ){
        // 2015-03-10 JOBSTREET CUSTOMIZE: if 'style' not exist, in responsive, we just set 100% width rather than set fixed calculation PX width
        return "100%";
      }
