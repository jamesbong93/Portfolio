                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Melaka Restaurants & Shops
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="col-lg-5">
						...
						<form  method="post" > 
						  <select class = "form-control" name = "STORENAME"> 
							...
							<?php 
							$sql_res = "SELECT STORENAME FROM storelistfoodmelaka ORDER BY STORENAME " ;
						...
						if(isset($_POST["res_add"])){
							...
							$query_add = "INSERT INTO storelistfoodmelaka(STORENAME) VALUES ('$STORENAME')";
						...
						if(isset($_POST["res_del"])){
							...
							$STORENAME = $_POST["STORENAME"];
							$query_dlt = "DELETE FROM storelistfoodmelaka WHERE STORENAME = '$STORENAME'";
						...
						$query_se = "SELECT * FROM storelistfoodmelaka ORDER BY STORENAME ";
						...
						<form  method="post" > 
						  ...
						  <select class = "form-control" name = "shop_name"> 
							...
							<?php 
							$sql_res = "SELECT STORENAME FROM storelistgrocerymelaka ORDER BY STORENAME";
							$result_res = $conn->query($sql_res);
							if ($result_res->num_rows > 0) {
						...
						if(isset($_POST["shop_name"])){
							...
							$query_add = "INSERT INTO storelistgrocerymelaka(STORENAME) VALUES ('$shop_name')";
						...
						if(isset($_POST["shop_del"])){
							...
							$query_dlt = "DELETE FROM storelistgrocerymelaka WHERE STORENAME = '$shop_name'";
						...
						$query_se = "SELECT * FROM storelistgrocerymelaka ORDER BY STORENAME ";
