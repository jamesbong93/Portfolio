                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Cheras Restaurants & Shops
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<div class="col-lg-5">
						...
						<form  method="post" > 
						  <select class = "form-control" name = "STORENAME"> 
							...
							<?php 
							$sql_res = "SELECT STORENAME FROM storelistfoodcheras ORDER BY STORENAME " ;
						...
						if(isset($_POST["res_add"])){
							...
							$query_add = "INSERT INTO storelistfoodcheras(STORENAME) VALUES ('$STORENAME')";
						...
						if(isset($_POST["res_del"])){
							...
							$STORENAME = $_POST["STORENAME"];
							$query_dlt = "DELETE FROM storelistfoodcheras WHERE STORENAME = '$STORENAME'";
						...
						$query_se = "SELECT * FROM storelistfoodcheras ORDER BY STORENAME ";
						...
						<form  method="post" > 
						  ...
						  <select class = "form-control" name = "shop_name"> 
							...
							<?php 
							$sql_res = "SELECT STORENAME FROM storelistgrocerycheras ORDER BY STORENAME";
							$result_res = $conn->query($sql_res);
							if ($result_res->num_rows > 0) {
						...
						if(isset($_POST["shop_name"])){
							...
							$query_add = "INSERT INTO storelistgrocerycheras(STORENAME) VALUES ('$shop_name')";
						...
						if(isset($_POST["shop_del"])){
							...
							$query_dlt = "DELETE FROM storelistgrocerycheras WHERE STORENAME = '$shop_name'";
						...
						$query_se = "SELECT * FROM storelistgrocerycheras ORDER BY STORENAME ";
