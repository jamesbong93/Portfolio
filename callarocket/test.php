...
<script type="text/javascript">
   ...
   $('form').submit();
	...
	function check_confirm_num(){
		...
		var x = document.forms["confirm_form"]["con_num"].value;
		var y = "<?php echo $sms_code;?>";
	...
	$result = $conn->query($sql_select_promoCode);
		...
		if($promodefound){
				...
				$sql = "INSERT INTO userrequests(userName, contactNumber, userAddress, category, storeList, timeFrame, requestBody, smsCode) VALUES
				 ('$name', '$contact', '$address', '$category', '$restaurant', '$time_slot', '$detail','$sms_code')";
		  ...
		  <div class="modal-dialog">
			<div class="modal-content">
			  <div class="modal-header">
				...
				<h4 class="modal-title">Please insert your confirmation code </h4>
			  </div>
			  <form name = "confirm_form" method = "post" action = "food_summary.php" onsubmit = "return check_confirm_num()">
			  <div class="modal-body">
				<input class = "form-control" type = "text" name = "con_num"  >
			  </div>
			  <div class="modal-footer">
			  <p class="pull-left"> Confirmation code will send to your mobile</p>
