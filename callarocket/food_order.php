...
<head>
  ...
  #form_att {
	position:absolute;left:150px;top:220px;bottom:0%;
	padding:30px;
...
<br><br><br><br>
    ...
    <div id = "form_att" class="col-md-4 col-md-offset-4" >
      ...
      <form name = "myform" class="form-horizontal" method = "post"  action = "food_confirmation.php"  onsubmit="return validateForm()" >
