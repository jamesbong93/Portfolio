...
abstract class Mbwx extends Online {
	//public $platformBaseUrl = 'https://182.148.123.7/cgi-bin/netpayment/pay_gate.cgi';
	public $platformBaseUrl = 'https://trade.mobaopay.com/cgi-bin/netpayment/pay_gate.cgi';

	public $secret = '';

	public $platformParam = ['apiName' => 'WEB_PAY_B2C', 'apiVersion' => '1.0.0.0', 'platformID' => 'MerchTest', 'merchNo' => '210001110100250', 'orderNo' => '', 'amt' => '', 'tradeDate' => '', 'merchUrl' => 'http://ralf.com:8040/pay/mbwxback', 'ClientIP' => '', 'choosePayType' => '5'];
