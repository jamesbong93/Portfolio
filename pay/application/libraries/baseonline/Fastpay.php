...
abstract class Fastpay extends Online {
	//public $platformBaseUrl = 'http://trade.777pay.cn/cgi-bin/netpayment/pay_gate.cgi';
	public $platformBaseUrl = 'http://trade.777pay.cn:8080/cgi-bin/netpayment/pay_gate.cgi';

	public $secret = '';

	public $platformParam = ['apiName' => 'WEB_PAY_B2C', 'apiVersion' => '1.0.0.0', 'platformID' => 'MerchTest', 'merchNo' => '210001110100250', 'orderNo' => '', 'amt' => '', 'tradeDate' => '', 'merchUrl' => 'http://ralf.com:8040/pay/fastpayback', 'ClientIP' => ''];
