	 ...
	 <div class="container-fluid">
				<div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Purchase History
                            </li>
                        </ol>
                    </div>
                </div>
				...
				$query_count = "SELECT * FROM purchase_history";
				...
				if(isset($_POST["date_sub"])){
						...
						$search = $_POST["date"];
						$query_se = "SELECT * FROM purchase_history,user_login,books where DATE_FORMAT(Purchase_Date, '%m/%d/%Y') LIKE '%". $search . "%' 
