        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="item.php" class="list-group-item active">Arts & Photography</a>
				 ...
				 <div class="thumbnail">
					...
					<div class="caption">
                        ...
                        <p>
							...
							<a href="item_info_before.php?ISBN_past=<?php echo $row["ISBN"]?> "class="btn btn-default">More Info</a>
                        </p>
                    </div>
