...
$user_id = $row_user["ID"];		
		...
		$query_wish = "SELECT DISTINCT * FROM books,wish_list,user_login
				 ...
				 <div class="thumbnail">
					...
					<div class="caption">
                        ...
                        <p>
							...
							<br><br><a href="item_info.php?ISBN_past=<?php echo $row["ISBN"]?> "class="btn btn-default">More Info</a>
							<a href="delete.php?user_id=<?php echo $user_id;?>&book_id=<?php echo $book_id;?>" class="btn btn-danger">Delete</a>
                        </p>
                    </div>
